...
- [ ] **중계기/companion 순찰 항목 후보 — "묵은 편지" 감지** (2026-08-10 kyle 제안):
  read=0 이 오래 유지되는 편지(= 감독·중계기·companion·슈퍼 넷 중 누구도 안 집음)는
  배달 사슬 고장의 신호다 — NOT_READY 편지 40분 방치 실사고가 실물. 대시보드에는
